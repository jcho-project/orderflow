    ...
    return (
      <tr className="hover:bg-gray-100 dark:hover:bg-gray-700" key={item.id}>
        ...
        <td className="p-4 space-x-2 whitespace-nowrap">
          ...
          <button onClick={deleteOrder} type="button" data-modal-toggle="delete-user-modal" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
