    ...
    <>
      <form action="#" method="GET" className="hidden lg:block lg:pl-2">
        ...
        <div className="relative flex mt-1 lg:w-96">
          ...
          <input type="text" name="search" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 w-full pl-10 p-2.5" placeholder="Search Order" />
        </div>
      </form>
    </>
  );
