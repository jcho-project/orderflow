...
function InventoryItem({ items }) {
  const { editInventory, deleteOrder, isChecked, setIsChecked, handleCheckboxChange } = useContext(OrderContext)
    ...
    return (
      <tr className="hover:bg-gray-100 dark:hover:bg-gray-700" key={item.id}>
        ...
        <td className="p-4 space-x-2 whitespace-nowrap">
          <button onClick={() => editInventory(item)} type="button" data-modal-toggle="edit-user-modal" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
